...
import { FrontendFeatureCustomerCatalogProductAdditionalInfoComponent, FrontendFeatureCustomerCatalogProductBackToProductsComponent, FrontendFeatureCustomerCatalogProductBreadCrumbsComponent, FrontendFeatureCustomerCatalogProductDescriptionComponent, FrontendFeatureCustomerCatalogProductOrderComponent, FrontendFeatureCustomerCatalogProductPhotosViewComponent, FrontendFeatureCustomerCatalogProductTitleComponent } from "@iorder-next/frontend/feature/customer/catalog/product";
