...
import { CatalogProductsFilterComponent, CatalogProductsOrderUnitsComponent, CatalogProductsViewSelectComponent } from '@iorder-next/frontend/feature/customer/catalog/products/header-products-info';
