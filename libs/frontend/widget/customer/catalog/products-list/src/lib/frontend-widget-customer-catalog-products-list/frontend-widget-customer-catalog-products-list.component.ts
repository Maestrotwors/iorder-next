...
import { FrontendFeatureCustomerCatalogProductsListCardViewComponent, FrontendFeatureCustomerCatalogProductsListListViewComponent } from '@iorder-next/frontend/feature/customer/catalog/products/products-list';
